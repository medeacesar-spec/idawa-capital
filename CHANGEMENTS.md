...
| **Conversion conservatrice** : convertir un dossier en participation conserve désormais identité (année/ville/stade), profil, **promoteur + évaluation**, et **rattache le journal du Suivi** (décisions, changements d'état, comités) à la société. | RPC vérifiée SQL, à tester en réel | **0038** |
