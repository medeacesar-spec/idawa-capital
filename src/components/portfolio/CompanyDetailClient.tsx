  ...
  return (
    ...
    <div>
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 14 }}>
        ...
        <button className="btn btn-ghost" onClick={() => router.push(`/portefeuille/${company.id}/fiche`)} style={{ flexShrink: 0 }} title="Fiche de suivi (selon la cadence de la société), prête à imprimer ou à envoyer">
